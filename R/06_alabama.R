...
if (FALSE) {
  ...
  ggsave(here('pres/al_demonstration_maps.png'), width = 4, height = 5)
  ...
  ggsave(here('pres/al_demonstration_harm.png'), width = 5, height = 4.5)
}
