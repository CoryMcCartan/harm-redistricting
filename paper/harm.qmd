...
The data used in these analyses are based on the full Census and all election returns for the included contests, and as such, there is no data inclusion.
