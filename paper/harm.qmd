...
We discuss this difference more in [Appendix @sec-connections], and compare the two measures empirically in @sec-nj.
...
The raw metrics, and these two counterintuitive results, can be better contextualized in comparison to the distribution across the sampled plans, something we discuss in [Appendix @sec-app-nj].
