...
@fig-nj-maps shows the baseline Democratic vote share by precinct, along with the Democratic and Republican commission proposals.
...
All data are publicly available and are included in the replication package for the manuscript: <https://github.com/corymccartan/harm-redistricting>.

# Code availability {.unnumbered}
All code is included in the replication package for the manuscript: <https://github.com/corymccartan/harm-redistricting>.
