...
For each of these sampled plans and the two proposals, we estimate the average harm and differential partisan harm versus the simulated baseline,[^9] and calculate the expected number of Democratic seats and several common partisan metrics, including partisan dislocation.
...
Both proposals are estimated to harm the average voter at a higher rate than most of the sampled plans, though the estimate for the Democratic plan is not statistically significant ($p=0.001$ for the Republican plan versus $p=0.061$ for the Democratic plan).
