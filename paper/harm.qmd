...
In general we do require the group identities to be fixed with respect to elections.[^1]
This is because some group identities, like partisan preference, may themselves change election-to-election.
Groups may need to be estimated with methods such as ecological inference [@king1997solution], as discussed in @sec-estimating.
...
There, the implicit counterfactual is a perfect predictor and the actual process harms individuals whenever it makes an incorrect prediction.
