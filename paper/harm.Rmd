...
To introduce and motivate the concepts of individual and differential harm, we will make use of Minissouri, a stylized representation of Missouri.
...
Despite the statewide popular vote favoring Republicans, under this plan Democrats would win two of the three seats.
In contrast, a more proportional plan \ref{fig:minissouri}(b) would elect two Republicans and one Democrat.

Our intuition tells us that plan (a) unfairly packs Republicans into a rural district, depriving them of one seat.
To turn this intuition into something more solid, we can consider which voters are harmed by the enactment of plan (a) over the alternative (b).
...
After identifying which voters are harmed by plan (a) (with plan (b) as a counterfactual), it is natural to examine the overall composition of these harmed voters.
...
Here, then the partisan differential harm of plan (a) is $-41.5\%$, meaning that the average Republican voter in Mininois is 41.5 percentage points more likely to be represented by a Democrat than an average Democrat is to be represented by a Republican, compared to the proportional plan.
