...
First, it operates at the level of the individual voter, and examine whether each voter is represented by the candidate of their choice.
...
A primary advantage of our proposed harm measures is that they our measures are defined at the individual level, which allows for the study of redistricting far beyond racial and partisan gerrymandering.
However, even for these important contexts, the measures provide an improvement over existing analytical approaches.
...
Thus there remains uncertainty about the extent that race plays a factor in primary elections, and consequently the role it should play in designing urban legislative maps.
