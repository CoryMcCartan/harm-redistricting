...
The latter four metrics are grounded in intuition over how to reliably identify a partisan gerrymander, and not in the larger theoretical framework of partisan symmetry [@katz2020].
...
The core of the voter choice model is the following specification for the $\pi_{jk}$, the preference of precinct $j$ for candidate $k$ on the logit scale:[^13] \begin{align*}
...
The matrix $\vb L_k$ contains the loading of candidate $k$ onto the latent space: When $\vb L_k$ and $\pref_{j}$ are nearby in latent space, then their product will be large, and the precinct's support for the candidate, $\pi_{jk}$, will be large.
