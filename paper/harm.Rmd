...
that is, a voter is harmed only if they are not represented by the candidate of their choice under $q$ but they would have been represented by their candidate of choice under the counterfactual plan $\tilde q$.
...
In general, $q$ will harm some individuals while $\tilde q$, and $\tilde q$ will harm a different set of individuals.
...
A natural extension of this definition is to separate individual candidate preference from vote choice. 
The latter defines election winners, but the former provides a more-broad harm measure.
Naturally, this approach requires auxiliary data to implement, such as a large-scale survey, as candidate preferences for non-voters are not directly inferred from election returns.
