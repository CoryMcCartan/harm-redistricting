...
allowing for the study of redistricting for any defined group memberships.
...
To apply our proposed framework to study the council district boundaries, must be able to we predict individual voting preferences under counterfactual districting plans.
...
We stress that the latent factor ecological inference model is not necessary for this kind of analysis; it is one choice out of many model which could provide estimated vote choices for individuals.
