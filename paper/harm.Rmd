...
Let $\Voters$ be the set of individuals, or voters, in the region and time period under consideration.
Individuals vote to select a candidate to represent each of a set of districts, indexed by $\Distrs$.
...
For an election $v$, we can tally the votes for each candidate and the candidate with the most votes wins.
