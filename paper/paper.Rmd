...
In a familiar pattern of partisan sorting, Democrats are sorted asymmetrically into a single population-dominating city whereas Republicans dominate the less ideologically segregated rural regions \[@chen:rodd:13\] \[@enos:brown:21\]. This allows for significantly greater variation in the expected partisanship of the districts drawn.
...
| State      | Plan                   | Total Harm | Differential Harm | Efficiency Gap | Partisan Bias | Mean-Median | Declination |
|------------|------------------------|------------|-------------------|----------------|---------------|-------------|-------------|
| Mininois   | "Fair"                 |            |                   |                |               |             |             |
| Mininois   | Democratic Gerrymander |            | -0.519            |                |               |             |             |
| Minissouri | Fair                   |            |                   |                |               |             |             |
| Minissouri | Democratic Gerrymander |            | -0.415            |                |               |             |             |
| Minissouri | Republican Gerrymander |            | 0.450             |                |               |             |             |
...
<!--
From here onward we will restrict our attention to the case of two groups---concretely, $\Groups=\{\dem,\rep\}$---and simply write $\Delta H(q)=\Delta^\dem_\rep H(q)$.
But the same concepts and definitions naturally carry over to the multigroup setting.
-->
...
\end{proof}
```
# Computing Harm and Fairness from Precinct-level Election Data {#app:formulas}
