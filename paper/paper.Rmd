...
But as those authors recognize, in evaluating a districting plan, it is critical to consider "if there is a fairer alternative." The inability of partisan bias and other existing measures to account for the space of counterfactual redistricting plans means that none of them may be interpreted in a vacuum.
