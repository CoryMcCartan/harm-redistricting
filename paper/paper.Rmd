...
Moving beyond these hueristic methods, we can use sampling methods that have defined target distributions to ensure that we characterize the space of applicable plans properly.
