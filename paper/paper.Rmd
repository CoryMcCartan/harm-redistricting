...
These problems have led @deford2020symmetry, among others, to recommend evaluating the presence of a gerrymander simply by comparing the expected number of seats won under the plan versus the simulations We agree with this recommendation, as it turns out that in the partisan case, with $\Groups=\{\dem,\rep\}$, differential harm is in fact closely related to the overall number of seats won by each party.
