...
To proceed with a legal challenge to an alleged gerrymander, a voter must demonstrate that their individual right to vote has been harmed by the enacted district boundaries [@1964reynolds; @1962baker]. This requires proof that *but for* the alleged gerrymander, the voter would have been more likely to elect their chosen candidate [@2004vieth; @2018league; @2019lewis].
...
Appendix \ref{app:corr} calculates these correlations across a number of states.
The most consistent correlation is that between our estimate of differential partisan harm and the expected number of seats won by each party, which is always above \_\_ in the states we study.
...
The table below reports the correlation between differential harm and the partisan gerrymandering metrics used in Section \ref{sec:nj} for \_\_ states which cover a wide range of partisan leans and number of seats.
