...
The expected number of Democratic seats and the differential partisan harm measures identify each gerrymanders as an outlier in the correct direction (two-sided $p=0.0002$ for expected seats), and as expected from Proposition \ref{prop:fairness}, these two measures are highly correlated.
