...
```{r nj-pairs, fig.cap="Scatterplots for all pairs of measures. Point lightness indicates the number of Democratic seats won (ranging from 7 (dark) to 10 (light)). The Democratic and Republican gerrymanders are shown with the blue and red lines and crosses. The dashed line indicates a value of zero. Below the diagonal, numbers indicate the absolute value of the correlation between variables.", fig.width=7, fig.height=7}
