...
These values are relatively directly interpretable; for example, the differential harm score of $-0.22$ means that an average Democratic voter is 22% less likely to be misrepresented than their average Republican counterpartisan.
